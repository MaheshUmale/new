...
def get_scan_data():
    ...
    try:
        ...
        squeeze_data = df[df['strategy_type'] == 'High_Potential'].to_dict('records')
        pullback_data = df[df['strategy_type'] == 'High_Probability'].to_dict('records')
        
        # Convert datetime objects to strings
        for record in squeeze_data + pullback_data:
...
def manage_settings():
    ...
    if request.method == 'GET':
        ...
        data = request.json
        # This would update the config file or in-memory settings
...
def get_scan_stats():
    ...
    try:
        ...
        squeeze_count = len(df[df['strategy_type'] == 'High_Potential'])
        pullback_count = len(df[df['strategy_type'] == 'High_Probability'])
